    ...
    <div v-if="capitulos">
        <div>
            <div class="flex lineaCapitulos" style="z-index:11111111; margin: -20% 0% 0% 31%; position:absolute;">
                <div v-for="capitulo in capitulos" v-bind:key="capitulo" class="flex lineaCapitulos">
            ...
            <div v-for="capitulo in capitulos" v-bind:key="capitulo" >
                <!-- {{chapter}} - {{capitulo.id}} -->
                        ...
                        <div class="row" style="margin:4% 0% 0% 0%;text-align: -webkit-center;">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a type="button" style="width:40%;" class="btn btn-block btn-primary" v-bind:href="'http://evolucion.website/playerchapter/'+capitulo.id" >Ir al Capitulo</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        mounted() { 
            axios
            .get('http://127.0.0.1:8000/playerchapters') //hace peticion de la secuencia a PlayerChapersController
            .then(response => {
