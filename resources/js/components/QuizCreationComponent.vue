                        ...
                        <div v-for="dato in datos" v-bind:key="dato.id">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" v-model="dato.name" placeholder="Nombre">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body"> 
                                        Registra aqui el Nombre, Descripcion y TIEMPO que durara la ejecucion del quizz, este podras editarlo en la creaciono del reto,                                         
                                    </div>
                                </div>
                            </div>                            
                            <div class="col-md-12">
...
<script>
    export default {
        ...
        methods: {
            ...
            addQuiz(){
                axios.post(('http://evolucion.website/quizzes'), {filas:this.questions, datos:this.datos} )
                .then(function (response) {
                    if (response.data == "") {                        
                        window.location = 'http://evolucion.website/quizzes';
                    } else {
                        alert(response.data);                        
                    }
